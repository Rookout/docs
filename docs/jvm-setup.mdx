...
#### Whitelisting Rookout

In OSGi, JBoss and Wildfly apps, Rookout must be whitelisted in order to run.

In an OSGi applicaiton, the Rookout package should be whitelisted (delegated) to the OSGi container by setting the following JVM options -
...
You can see our [JBoss](https://github.com/Rookout/deployment-examples/tree/master/java-jboss) and [Wildfly](https://github.com/Rookout/deployment-examples/tree/master/java-wildfly-docker) deployment examples to learn how to whitelist Rookout in those applications. 
