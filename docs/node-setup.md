...
For example let's say I use https: with the commit 2f79053d7bc7c9c9561a30dda202b3dcd2b72b90 and I use the Lodash package () from its master branch:
...
By default, Rookout ignores your project's dependencies in the `` folder.

If the project you wish to debug is installed as a node module, create a file in the project's repository root folder, called ``, with the following content:
