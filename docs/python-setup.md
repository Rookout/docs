...
If you are using one of those servers, You can set the fork argument in the SDK api to true to automatically enable Rookout in forked processes, otherwise - You must be initialize Rookout in each of the workers processes.  
