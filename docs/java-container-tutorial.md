...
First thing's first, choose which application you will use.
If you don't have one readily available, you can use our [sample application](https://github.com/Rookout/java-tutorial-2022).  
