...
To verify the application version you are executing against the source files you are using to set breakpoints, include your source files within your JAR/WAR/EAR library.
